...
//    );
    ...
    $options[] = array(
        'name' => __('Custom Script ( example: Google Analytics )', 'options_framework_theme'),
        'id' => 'sc_custom_code',
        'std' => '',
        'type' => 'textarea');    
    ...
    $options[] = array(
        ...
        'desc' => __('Choose light or dark skin', 'options_framework_theme'),
        'id' => 'sc_theme_skin',
        'std' => 'dark',
        'type' => 'radio',
        'options' => array(
...
//        "section" => "nav");
    ...
    $path = get_template_directory_uri() . '/inc/images/bride.jpg';    
    $options[] = array(
    ...
    $options[] = array(
        ...
        'type' => 'text');
    $path = get_template_directory_uri() . '/inc/images/jesse.jpg';
    $options[] = array(
    ...
    $path = get_template_directory_uri() . '/inc/images/blur.jpg'; 
    // box 1
    $options[] = array(
    ...
    $options[] = array(
        ...
        'desc' => __('Background image for box #1', 'options_framework_theme'),
        'id' => 'sc_box1_image',
        'std' => $path,
        'type' => 'upload');    
    ...
    $options[] = array(
        ...
        'desc' => __('Background image for box #2', 'options_framework_theme'),
        'id' => 'sc_box2_image',
        'std' => $path,
        'type' => 'upload'); 
    ...
    $options[] = array(
        ...
        'desc' => __('Background image for box #3', 'options_framework_theme'),
        'id' => 'sc_box3_image',
        'std' => $path,
        'type' => 'upload'); 
...
function sc_avenue_options_display_sidebar() {
    ...
    <div class="width30 left ml2p">
        ...
        <div class="sc-tab-option">
            <a href="https://wordpress.org/support/theme/byblos" target="_blank">
                Support Forum
            </a>
        </div>    
        ...
        <ol>
            <li>An additional light color skin</li>
            <li>Add up to 5 slides to the slider</li>
            <li>3 additional theme colors (Monochrome, Aqua and Purple)</li>
            <li>the option to remove the smartcat branding</li>
        </ol>

        <div class="sc-tab-option">
            <a href="http://smartcatdesign.net/downloads/byblos/" target="_blank">
